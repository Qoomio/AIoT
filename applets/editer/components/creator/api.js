...
const api = {
  ...
  routes: [
    {
      // Create new file - POST /edit/creator/_api/file
      path: '/_api/file',
      method: 'POST',
      handler: async (req, res) => {
        try {
          ...
          if (!filePath) {
            logActivity('creator', 'file_create_error', { error: 'Missing filePath' });
            return sendApiResponse(res, 400, false, null, 'File path is required');
          }

          logActivity('creator', 'file_create_request', { filePath, hasTemplate: !!template });
          ...
          logActivity('creator', 'file_create_success', { filePath, size: result.size });
          ...
          logActivity('creator', 'file_create_error', { error: error.message });
    ...
    {
      // Create new folder - POST /edit/creator/_api/folder
      path: '/_api/folder',
      method: 'POST',
      handler: async (req, res) => {
        try {
          ...
          if (!folderPath) {
            logActivity('creator', 'folder_create_error', { error: 'Missing folderPath' });
            return sendApiResponse(res, 400, false, null, 'Folder path is required');
          }

          logActivity('creator', 'folder_create_request', { folderPath });
          
          const result = await createFolder(folderPath);
          
          logActivity('creator', 'folder_create_success', { folderPath });
          ...
          logActivity('creator', 'folder_create_error', { error: error.message });
    ...
    {
      // Get available templates - GET /edit/creator/_api/templates
      path: '/_api/templates',
      method: 'GET',
      handler: async (req, res) => {
        try {
          logActivity('creator', 'templates_request', { method: req.method });
          
          const templates = await getTemplatesList();
          
          logActivity('creator', 'templates_success', { count: templates.length });
          ...
          logActivity('creator', 'templates_error', { error: error.message });
          sendApiResponse(res, 500, false, null, error.message);
        }
      }
    },
    {
      // Delete file - DELETE /edit/creator/_api/file
      path: '/_api/file/*',
      method: 'DELETE',
      handler: async (req, res) => {
        try {
          // Extract file path from URL - remove the prefix properly
          const prefix = '/edit/creator/_api/file/';
          ...
          if (!filePath) {
            logActivity('creator', 'file_delete_error', { error: 'Missing filePath' });
            return sendApiResponse(res, 400, false, null, 'File path is required');
          }

          logActivity('creator', 'file_delete_request', { filePath });
          
          const result = await deleteFile(filePath);
          
          logActivity('creator', 'file_delete_success', { filePath, size: result.size });
          ...
          logActivity('creator', 'file_delete_error', { error: error.message });
    ...
    {
      // Delete folder - DELETE /edit/creator/_api/folder
      path: '/_api/folder',
      method: 'DELETE',
      handler: async (req, res) => {
        try {
          ...
          if (!folderPath) {
            logActivity('creator', 'folder_delete_error', { error: 'Missing folderPath' });
            return sendApiResponse(res, 400, false, null, 'Folder path is required');
          }

          logActivity('creator', 'folder_delete_request', { folderPath, recursive });
          
          const result = await deleteFolder(folderPath, recursive);
          
          logActivity('creator', 'folder_delete_success', { folderPath, recursive });
          ...
          logActivity('creator', 'folder_delete_error', { error: error.message });
    ...
    {
      // Rename file or folder - PATCH /edit/creator/_api/rename
      path: '/_api/rename',
      method: 'PATCH',
      handler: async (req, res) => {
        try {
          ...
          if (!oldPath || !newPath) {
            logActivity('creator', 'rename_error', { error: 'Missing oldPath or newPath' });
            return sendApiResponse(res, 400, false, null, 'Both oldPath and newPath are required');
          }

          logActivity('creator', 'rename_request', { oldPath, newPath });
          
          const result = await renameItem(oldPath, newPath);
          
          logActivity('creator', 'rename_success', { oldPath, newPath, isFile: result.isFile });
          ...
          logActivity('creator', 'rename_error', { error: error.message });
    ...
    {
      // Duplicate file - POST /edit/creator/_api/duplicate/file
      ...
      handler: async (req, res) => {
        try {
          ...
          if (!sourcePath || !targetPath) {
            logActivity('creator', 'duplicate_file_error', { error: 'Missing sourcePath or targetPath' });
            return sendApiResponse(res, 400, false, null, 'Both sourcePath and targetPath are required');
          }

          logActivity('creator', 'duplicate_file_request', { sourcePath, targetPath });
          
          const result = await duplicateFile(sourcePath, targetPath);
          
          logActivity('creator', 'duplicate_file_success', { sourcePath, targetPath, size: result.size });
          ...
          logActivity('creator', 'duplicate_file_error', { error: error.message });
    ...
    {
      // Duplicate folder - POST /edit/creator/_api/duplicate/folder
      ...
      handler: async (req, res) => {
        try {
          ...
          if (!sourcePath || !targetPath) {
            logActivity('creator', 'duplicate_folder_error', { error: 'Missing sourcePath or targetPath' });
            return sendApiResponse(res, 400, false, null, 'Both sourcePath and targetPath are required');
          }

          logActivity('creator', 'duplicate_folder_request', { sourcePath, targetPath });
          
          const result = await duplicateFolder(sourcePath, targetPath);
          
          logActivity('creator', 'duplicate_folder_success', { sourcePath, targetPath });
          ...
          logActivity('creator', 'duplicate_folder_error', { error: error.message });
